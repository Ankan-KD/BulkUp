  ...
  return (
    <div className="space-y-3">
      ...
      <Card className="p-4 flex items-start gap-3">
        <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-aurora-500/12 text-aurora-500">
      ...
      <div className="grid grid-cols-2 gap-2.5">
        <Card className="p-3.5 flex items-center gap-3">
          <span className="flex h-9 w-9 items-center justify-center rounded-full bg-ember-500/10 text-ember-500">
        ...
        <Card className="p-3.5 flex items-center gap-3">
          <span className="flex h-9 w-9 items-center justify-center rounded-full bg-nova-500/10 text-nova-500">
      ...
      <Card className="p-4">
        <div className="flex items-center justify-between">
          ...
          {summary.weeklyStreak > 0 && (
            <div className="flex items-center gap-1.5 rounded-full bg-ember-500/10 text-ember-500 px-3 py-1.5">
              <StreakIcon className="w-3.5 h-3.5" />
              <span className="text-xs font-semibold">{summary.weeklyStreak}-day streak</span>
            </div>
          )}
        </div>
        <div className="mt-3 h-1.5 w-full rounded-full bg-nova-900/10 dark:bg-nova-100/10 overflow-hidden">
          <div
            className="h-full bg-gradient-to-r from-nova-500 to-aurora-400 transition-all duration-500"
      ...
      <Card className="p-4 flex items-center gap-3">
        <div className="relative h-12 w-12 shrink-0">
          <svg viewBox="0 0 44 44" className="-rotate-90 h-12 w-12">
            <circle cx="22" cy="22" r="18" strokeWidth="4" className="fill-none stroke-nova-100 dark:stroke-nova-900" />
            <circle
              cx="22"
              cy="22"
              r="18"
      ...
      {summary.weightTrendLabel && (
        <Card className="p-4 flex items-center gap-3">
          <span className="flex h-9 w-9 items-center justify-center rounded-full bg-aurora-500/10 text-aurora-500">
