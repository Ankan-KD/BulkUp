 ...
 *
 * `cardTint` is a solid `!bg-*` (important) background colour rather than a
 * gradient — cards also carry the `.glass-panel` class, whose plain CSS
 * `background` declaration is emitted after Tailwind's utility layer and
 * would otherwise always win the cascade and hide a non-important tint.
 * The `!` forces the category colour through regardless of source order.
 */
export interface CategoryStyle {
  ...
  accentBorder: string;
  /** Soft, classy full-card background tint — visible at a glance without reading as bright/loud. */
  cardTint: string;
...
export const CATEGORY_STYLES: Record<FoodCategory, CategoryStyle> = {
  protein: {
    ...
    cardTint: "!bg-amber-500/[0.16] dark:!bg-amber-400/[0.21]",
  ...
  grain: {
    ...
    cardTint: "!bg-emerald-500/[0.16] dark:!bg-emerald-400/[0.21]",
  ...
  vegetable: {
    ...
    cardTint: "!bg-lime-500/[0.16] dark:!bg-lime-400/[0.21]",
  ...
  fruit: {
    ...
    cardTint: "!bg-pink-500/[0.16] dark:!bg-pink-400/[0.21]",
  ...
  dairy: {
    ...
    cardTint: "!bg-sky-500/[0.16] dark:!bg-sky-400/[0.21]",
  ...
  fat: {
    ...
    cardTint: "!bg-purple-500/[0.16] dark:!bg-purple-400/[0.21]",
  ...
  custom: {
    ...
    cardTint: "!bg-violet-500/[0.16] dark:!bg-violet-400/[0.21]",
  ...
  other: {
    ...
    cardTint: "!bg-slate-500/[0.14] dark:!bg-slate-400/[0.18]",
